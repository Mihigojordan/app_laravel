...
Route::middleware(['auth:api', 'Is_Active'])->group(function () {
    ...
    Route::post('payroll/{id}/approve', 'hrm\PayrollController@approve');
    Route::post('payroll/{id}/reject', 'hrm\PayrollController@reject');
    ...
    //--------------------------------------------------------------------------\\
    // Note: Reusing existing PurchasesController but labeled as Purchase Orders in frontend
    ...
    Route::get('chart_of_accounts', 'AccountController@chart_of_accounts');
    Route::get('receivable_accounts', 'AccountController@receivable_accounts');
    Route::get('payable_accounts', 'AccountController@payable_accounts');
    Route::get('seed_finance_translations', 'AccountController@seed_finance_translations');
    ...
    Route::post('mark_notifications_as_read', 'UserController@markNotificationsAsRead');
