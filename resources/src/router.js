...
const baseRoutes = [
    {
        ...
        children: [
...

            {
                ...
                path: "/app/finance/chart_of_accounts",
                component: () =>
                    import(
                        /* webpackChunkName: "chart_of_accounts" */ "./views/app/pages/accounts/chart_of_accounts"
                    )
            },

            {
                name: "receivable_accounts",
                path: "/app/finance/receivable",
                component: () =>
                    import(
                        /* webpackChunkName: "receivable_accounts" */ "./views/app/pages/accounts/receivable_accounts"
                    )
            },

            {
                name: "payable_accounts",
                path: "/app/finance/payable",
                component: () =>
                    import(
                        /* webpackChunkName: "payable_accounts" */ "./views/app/pages/accounts/payable_accounts"
                    )
            },
            ...
            //Requisitions
            {
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "requisitions" */ "./views/app/pages/requisitions"
                    ),
                redirect: "/app/requisitions/list",
                children: [
                    {
                        name: "index_requisition",
                        path: "list",
                        component: () =>
                            import(
                                /* webpackChunkName: "index_requisition" */ "./views/app/pages/requisitions/index_requisition"
                            )
                    },
                    {
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "store_requisition" */
                                "./views/app/pages/requisitions/create_requisition"
                            )
                    },
                    {
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "edit_requisition" */ "./views/app/pages/requisitions/edit_requisition"
                            )
                    }
                ]
            },
