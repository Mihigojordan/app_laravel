          ...
          <b-row>
           ...
           <b-col md="12">
             <validation-provider
               ...
               v-slot="validationContext"
             >
               <b-form-group :label="$t('Account_Type') + ' ' + '*'">
                 <b-form-select
                   v-model="account.type"
                   :state="getValidationState(validationContext)"
                   aria-describedby="type-feedback"
                 >
                   <b-form-select-option value="Asset">Asset</b-form-select-option>
                   <b-form-select-option value="Liability">Liability</b-form-select-option>
                   <b-form-select-option value="Revenue">Revenue</b-form-select-option>
                   <b-form-select-option value="Expense">Expense</b-form-select-option>
                 </b-form-select>
           ...
           <b-col md="12" class="mb-3">
             <b-form-checkbox v-model="account.is_default">
               {{ $t('is_default') }}
             </b-form-checkbox>
           </b-col>
    ...
    Create_Account() {
      ...
      axios
        .post("accounts", {
          ...
          is_default: this.account.is_default,
