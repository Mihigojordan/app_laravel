          ...
          <b-col lg="12" md="12" sm="12">
            <b-card no-body :header="$t('SystemSettings')">
              <b-card-body>
                ...
                <b-col md="4" class="mt-4 mb-4">
                    <label class="checkbox checkbox-primary mb-3"><input type="checkbox" v-model="setting.two_factor_auth"><h5>Two Factor Auth (OTP Email)</h5><span class="checkmark"></span></label>
                </b-col>
...
export default {
  ...
  methods: {
    ...
    Update_Settings() {
      ...
      self.data.append("two_factor_auth", self.setting.two_factor_auth);
