      ...
      <div>
        <ul class="navigation-left">
          ...
          <li
            ...
            @mouseenter="toggleSubMenu"
            class="nav-item"
            :class="{ active: selectedParentMenu == 'procurement' }"
            data-item="procurement"
            :data-submenu="true"
          >
            <a class="nav-item-hold" href="#">
              <i class="nav-icon i-Receipt"></i>
              <span class="nav-text">{{$t('Procurement')}}</span>
            </a>
            <div class="triangle"></div>
          </li>
          <li
          ...
          <li
            ...
            @mouseenter="toggleSubMenu"
            class="nav-item"
            :class="{ active: selectedParentMenu == 'finance' }"
            data-item="finance"
            :data-submenu="true"
          >
            <a class="nav-item-hold" href="#">
              <i class="nav-icon i-Financial"></i>
              <span class="nav-text">{{$t('Finance')}}</span>
            </a>
            <div class="triangle"></div>
          </li>
    ...
    >
      <div ref="sidebarChild">
        ...
        <ul
          class="childNav d-none"
          data-parent="finance"
          :class="{ 'd-block': selectedParentMenu == 'finance' }"
        >
        ...
        <li
          ...
          >
            <router-link tag="a" class to="/app/accounts">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{$t('Accounts')}}</span>
            </router-link>
          </li>
          ...
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('account')"
          >
            <router-link tag="a" class to="/app/finance/chart_of_accounts">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{$t('ChartOfAccounts')}}</span>
            </router-link>
          </li>
          ...
          >
            <router-link tag="a" class to="/app/finance/receivable">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{$t('AccountsReceivable')}}</span>
            </router-link>
          </li>

          <li
            class="nav-item"
            v-if="currentUserPermissions && currentUserPermissions.includes('Purchase_view')"
          >
            <router-link tag="a" class to="/app/finance/payable">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{$t('AccountsPayable')}}</span>
            </router-link>
          </li>
        ...
        <ul
          class="childNav d-none"
          data-parent="procurement"
          :class="{ 'd-block': selectedParentMenu == 'procurement' }"
        >
          <li
            class="nav-item"
            v-if="currentUserPermissions && currentUserPermissions.includes('Purchases_add')"
          >
            <router-link tag="a" class to="/app/requisitions/store">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name">{{$t('CreateRequisition')}}</span>
            </router-link>
          </li>
          <li
            class="nav-item"
          ...
          >
            <router-link tag="a" class to="/app/requisitions/list">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{$t('ListRequisitions')}}</span>
            </router-link>
          </li>
          ...
          >
            <router-link tag="a" class to="/app/purchases/store">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name">{{$t('CreatePurchaseOrder')}}</span>
            </router-link>
          </li>
          <li
            class="nav-item"
          ...
          >
            <router-link tag="a" class to="/app/purchases/list">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{$t('ListPurchaseOrders')}}</span>
            </router-link>
          </li>
